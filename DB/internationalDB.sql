...
INSERT INTO `application_admission_tests` VALUES (18,9,'SAT','3','3','3'),(57,80,'GRE','2','2','2'),(64,16,'GMAT','2','2','2'),(65,16,'GRE','22','22','22'),(68,87,'GMAT','2','2','2'),(69,87,'GRE','22','22','22'),(72,88,'GRE','1','1','1'),(79,92,'GMAT','3','4','5'),(80,97,'GRE','4','56','6'),(176,91,'GMAT','23','23','2'),(177,91,'GRE','32','22','23'),(183,209,'GMAT','','','');
...
INSERT INTO `application_children` VALUES (75,6,NULL,1),(89,3,NULL,1),(151,8,12,1),(262,80,3,1),(263,80,2,0),(270,16,4,1),(271,16,2,0),(276,87,4,1),(277,87,2,0),(288,92,4,1),(289,92,2,0),(290,97,5,1),(291,97,2,0),(358,133,5,1),(359,133,3,0),(504,249,2,1),(505,249,2,0),(512,98,4,1),(513,98,2,0),(524,91,3,1),(525,91,1,0),(530,258,4,1),(531,258,2,0),(536,209,2,1),(537,209,1,1),(539,196,1,1);
...
INSERT INTO `application_skill` VALUES (110,98,'Germany','Engineers Australia','Incompleted','In Progress',1,NULL,NULL),(111,98,'New Zealand','Engineers Australia','Completed','Documents Pending',1,NULL,NULL),(117,209,'France','','','',0,NULL,NULL);
...
INSERT INTO `registration_children` VALUES (13,5,12,1),(14,5,10,0),(19,10,4,1),(20,10,2,0),(21,12,4,1),(22,12,2,0),(29,16,4,1),(30,16,2,0),(31,19,5,1),(32,19,2,0),(100,74,2,1),(101,74,2,0),(112,15,3,1),(113,15,1,0),(118,81,2,1),(119,81,1,1),(136,77,4,1),(137,77,2,0);
...
INSERT INTO `registration_skill` VALUES (72,81,'France','','','',0,NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=2861 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `user_process_assignments`
--
...
CREATE TABLE `user_process_assignments` (
  ...
  CONSTRAINT `user_process_assignments_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `user_process_assignments`
--

LOCK TABLES `user_process_assignments` WRITE;
/*!40000 ALTER TABLE `user_process_assignments` DISABLE KEYS */;
INSERT INTO `user_process_assignments` VALUES (24,4,'Skill Assessment',NULL,'2026-05-27 10:26:46','2026-05-27 10:26:46'),(25,3,'Coaching',NULL,'2026-05-27 10:27:22','2026-05-27 10:27:22'),(26,3,'Language',NULL,'2026-05-27 10:27:22','2026-05-27 10:27:22'),(27,3,'Migration',5,'2026-05-27 10:27:22','2026-05-27 10:27:22'),(28,3,'Migration',6,'2026-05-27 10:27:22','2026-05-27 10:27:22'),(53,11,'Ticketing',NULL,'2026-05-29 05:39:25','2026-05-29 05:39:25'),(54,11,'Study',2,'2026-05-29 05:39:25','2026-05-29 05:39:25'),(55,11,'Migration',2,'2026-05-29 05:39:25','2026-05-29 05:39:25');
/*!40000 ALTER TABLE `user_process_assignments` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `users` VALUES (1,'admin','123','ashwini1suresh@gmail.com','3728374283774','admin','Working',1,1,'admin','','',0,'admin','2026-01-29 06:28:03'),(3,'ashwini','$2b$10$R8IWHkgB3VF96H44zk74be9MpF7/YdPyPBY08QtVaeZRwxoR9d7MC','ashwini1suresh@gmail.com','9446885925','Admin','Working',1,1,'admin','','',0,'admin','2026-01-29 09:47:49'),(4,'spp','123','123','123','staff','working',1,1,'staff','0','0',0,'staff','2026-05-27 09:15:27'),(10,'test1','$2b$10$//b5g8Sr4boFfUSSuZrfUOidrxEMC6uDUyezirgLf.xnDDp7ysxo2','123','123','Staff','Inactive',2,2,'staff','','',0,'staff','2026-05-29 04:40:39'),(11,'test2','$2b$10$6Unc6E6ayPXc4yCeHmWO1Ov4vGds71EU6osntbmwqMId6sctK3Nhq','123','123','Staff','Working',3,1,'staff','','',0,'staff','2026-05-29 04:41:09');
...
-- Dump completed on 2026-05-29 14:10:38
